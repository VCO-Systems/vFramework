...
CREATE TABLE RGH.dbo.WEB_SESSION
	(WEB_SESSION_ID int NOT NULL,
	 LOGIN_USER_ID varchar(15) NOT NULL,
	 SESSION_XML char(8000) NOT NULL,
	 LAST_TRANS_TIME datetime NULL,
	 CREATE_DATE_TIME datetime NULL,
	 MOD_DATE_TIME datetime NULL,
	 USER_ID varchar(15) NULL
	 CONSTRAINT PK_WEB_SESSION PRIMARY KEY NONCLUSTERED (WEB_SESSION_ID)
	)
GO